    ...
    <div className="relative w-full max-w-2xl mx-auto perspective-1000">
      ...
      >
        ...
        >
          ...
          <div className="space-y-8 cursor-pointer" onClick={handleFlip}>
        ...
        {/* 背面 - 显示翻译和详细信息 */}
        <div
          className="absolute top-0 left-0 w-full min-h-[400px] bg-gradient-to-br from-primary to-secondary rounded-clay-lg p-8 shadow-clay-lg backface-hidden cursor-pointer"
          style={{
            backfaceVisibility: 'hidden',
        ...
        >
          <div className="h-full flex flex-col justify-center space-y-6 text-white">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <span className="px-3 py-1 bg-white/20 backdrop-blur-sm rounded-clay text-sm">
                {chunk.scenario}
              </span>
              {chunk.tags.map((tag) => (
                <span
                  key={tag}
                  className="px-3 py-1 bg-white/20 backdrop-blur-sm rounded-clay text-sm"
                >
                  #{tag}
                </span>
              ))}
